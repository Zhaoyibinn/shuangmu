...
data_root_path = "huojian/d455_huojian_ce_nojgg"
...
depth_dir = 'depth_outputs/d455_huojian_ce_nojgg'
...
#     points=points_list,  # Refinement point
#     labels=labels_list,  # Positive point
#     iou=0.9,
# )
# results[0].show()
