...
left_img_path = "imgs\hik\left\\1.bmp"
right_img_path = "imgs\hik\\right\\5.bmp"
...
extri = cv2.FileStorage('extrinsics.yml', cv2.FILE_STORAGE_READ)
intri = cv2.FileStorage('intrinsics.yml', cv2.FILE_STORAGE_READ)
